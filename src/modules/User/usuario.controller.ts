...
export const createUsuario = async (req: Request, res: Response) => {
    try {
        ...
        const usuarioData: UserType = UserSchema.parse(req.body);
        ...
        await UserProgressModel.create({
            data: {
                ...
                active_course_id: matematicasid
            },
        })
        await UserProgressModel.create({
            data: {
                user_id: nuevoUsuario.id,
                active_course_id: comunicacionid
            },
        })
...
export const updateUsuario = async (req: Request, res: Response) => {
    try {
        ...
        const usuarioData: Partial<UserType> = UserSchema.partial().parse(req.body);
